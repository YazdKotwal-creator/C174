/*AFRAME.registerComponent("atoms", {
    ...
    createAtoms: async function (element) {
        ...
        var numOfElectrons = element.num_of_electrons;
        ...
        marker.setAttribute("id", `${elementName}-${barcodeValue}`);
        marker.appendChild(atom)

        var card = document.createElement("a-entity");
        card.setAttribute("id", `${elementName}`);
        ...
        nucleus.setAttribute("id", `nucleus-${barcodeValue}`);
